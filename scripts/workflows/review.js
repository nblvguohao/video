...
const REVIEWERS = [
  ...
  { id: 'R2', emphasis: '原创性与学术贡献：与最接近文献相比新在哪里（可用 Consensus/Scholar Gateway 核实）；框架/指标是否有理论基础；是否像企业宣传' },

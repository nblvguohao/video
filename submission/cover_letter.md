[Author letterhead / date — author to complete]
...
variety actually passed through, so no one could tell whether the reform changed *what*
enters the seed market rather than only *how much*. By parsing a previously unused feature of
official approval announcements — the name of the trial each variety was tested in — we
construct the first record-level trial-channel variable for this system and show that,
within the same approval year, ecological trial group and named check, self-organised-trial
entrants carry a systematically worse third-party-assayed grain-processing and appearance
quality (consortium arm: head-rice percentage −1.84 percentage points, chalkiness +1.11
points, probability of a stated national quality grade −12.2 points), while their
applicant-measured yield performance is, if anything, higher. This sign separation — quality
measured by an independent third party deteriorates while performance measured by the
...
direction the Ministry of Agriculture and Rural Affairs itself had already taken: on 31
August 2022, the Ministry's General Office issued a notice launching a special rectification
campaign directed at green-channel and consortium-trial practices (cited in our Institutional
Background, §2, and discussed in §8.3). Our paper does not allege fraud or manipulation by
any applicant — we are explicit throughout that our design cannot distinguish measurement
discretion from applicants self-selecting into channels with different admission thresholds,
and we use the phrase "measurement discretion," not "fraud" or "manipulation," throughout. We
read our finding as an independent, quantitative corroboration of the direction the
Ministry's own 2022 rectification notice already took, not as a claim that regulators were

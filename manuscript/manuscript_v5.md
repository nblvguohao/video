...
The sign separation in Sections 5–6 is consistent with measurement discretion in self-organised trials, but equally consistent with a cruder alternative: the self-organised channels may simply admit varieties bred from a narrower germplasm base, so the quality deficit records *what* enters rather than *how* it is measured. The announcements support a direct test, since each names the cross that produced the variety, following a documented history of the germplasm behind China's approved rice varieties itself becoming more diverse through introduced foreign lines (Shi and Hu, 2017).
...
Abi Younes G, de Rassenfosse G. 2024. Replicable patent indicators using the Google Patents Public Datasets. Australian Economic Review, 57, 102–113.
...
Bian Y, Yan S, Yi Z, Guan X, Chen Y. 2022. Quality certification in agricultural supply chains: Implications from government information provision. Production and Operations Management, 31, 1456–1472.

Bonsall S B, Gillette J R, Pundrich G, So E C. 2024. Conflicts of interest in subscriber-paid credit ratings. Journal of Accounting and Economics, 77, 101614.

Deng H, Yu C, Jin Y, Pray C, Liu C, Deng L. 2025. How is China shaping global food supply chains? Insights from the seed industry. European Review of Agricultural Economics. (Online first at time of writing; final volume/pages not yet assigned.)
...
Miao Y, Sun J, Liu R, Huang J, Sheng J. 2025. Bridging the quality-price gap: Unlocking consumer premiums for high-quality rice in China. Foods, 14, 1184.
...
Qin Y, Su K. 2026. From lab to market: Industrialization barriers and regulation optimization for new breeding technologies in China. GM Crops & Food. (Online first at time of writing; final volume/pages not yet assigned.)
...
Wang S, Wang S, Zhao C, et al. 2024. Overview of China's crop variety approval system and comparison with other countries (in Chinese). Science and Technology of Cereals, Oils and Foods, 32, 211–218.

Xiang C, Yang R, Wang X, Huang J. 2025. Impact of seed regulation reform on licensing fees of varieties in China. Agribusiness.

Xu S. 2021. Rethinking the liberation of China's seed market: A comparative study of China's regulatory frameworks with EU and US. Agroecology and Sustainable Food Systems, 251–272. (Volume number not independently confirmed at time of writing; flagged for author verification before submission.)

Zhao Y, Deng H, Hu R, Xiong C. 2022. Impact of government policies on seed innovation in China. Agronomy, 12, 917.

Zheng Y, Bar T. 2023. Certifier competition and audit grades: An empirical examination using food safety certification. Applied Economic Perspectives and Policy, 45, 182–196.

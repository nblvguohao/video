// ============================================================================
// WORKED EXAMPLE, NOT GENERIC INFRASTRUCTURE.
// This is the actual Phase-1 evidence-sweep script from a real sci_writer run
// (case: Winall Hi-tech Seed / 荃银高科, a Chinese hybrid-rice seed company).
// The engineering pattern below — args.dims selecting a subset of a DIMS map,
// each dim spawning one agent() with a shared ENV_NOTE, then a Verify phase
// that re-checks the top decision-critical facts — is reusable as-is.
// The ALL_DIMS content (company financials, variety portfolio, R&D projects...)
// is specific to that case and MUST be replaced with dimensions designed for
// your new case during Phase 1 planning (see references/phase1_evidence.md).
// Keep this file as a calibration reference for "how much specificity and
// verification rigor one dimension prompt should have."
// ============================================================================
export const meta = {
  name: 'evidence-sweep-part',
  description: 'Parameterized evidence sweep: runs the dimensions named in args.dims, writes evidence/*.md, then adversarially verifies decision-critical facts',
  phases: [

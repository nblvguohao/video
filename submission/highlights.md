...
**Manuscript:** "Mining administrative approval records for technology assessment:
record-level trial-channel indicators and third-party-assayed grain quality in China's rice
variety registrations, 2017–2022"
...
**Changed at v4** (see `manuscript/review/change_log_v3_to_v4.md` §8): bullets 1 and 5 are
new and carry the paper's S&T-intelligence contribution — mining an administrative text
corpus into a record-level indicator set, and the field-level data-reliability diagnostic.
They replace two v3 bullets (two-arm estimation; the focal-firm counter-case), both of which
remain fully reported in the manuscript body (§4.3/§5.3/R1 and §7 respectively).

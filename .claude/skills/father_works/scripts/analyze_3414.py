...
trial.json 最小结构：
{
  ...
  "level_rates": {"N": [0,90,180,270],         # 各因素 4 个水平的实际用量 kg/hm2（示例值，
                  "P": [0,45,90,135],          #   按本试验 1.3 的设计填；1水平=0.5×2水平、
                  "K": [0,60,120,180]},        #   3水平=1.5×2水平）
  "prices": {"grain": 3.00,                     # 粮食收购价必填（示例值，按当地当年实际填）
             "N": 4.35, "P": 8.33, "K": 5.00},  # 养分单价；若给了 products 可省略
  "products": {                                 # 可选：由肥料实物价与养分含量推导养分单价，
    "N": {"price": 2.00, "content": 0.46},      # 比直接写养分单价更准（正文也按实物价交代）
    "P": {"price": 1.00, "content": 0.12},
    "K": {"price": 3.00, "content": 0.60}},
  "traits": {                                   # 可选，缺则跳过性状分析
     "株高": [...], "穗长": [...], "有效穗": [...],
     "每穗总粒数": [...], "每穗实粒数": [...],
     "结实率": [...], "千粒重": [...]

...
**RQ3（机制个案｜反例检验）**
作为改革期国审份额上升最快的单一主体、育繁推一体化企业与水稻"强优势阵型"企业，荃银高科的通道选择与性状组合是否偏离同行？其偏离的方向能否排除"企业比科研单位更粗放"这一替代解释？（同时如实纳入该公司订单粮食业务毛利率 2025H1 约 −0.09%（全年 −1.31%）、2025 年归母净利 −2.12 亿元由盈转亏、2024 年报被出具保留意见、2026 年因虚假记载被罚 300 万元并变更为 ST 荃银等负面事实。）
...
| W4 | **负面事实与正面事实同段呈现** | 凡出现"荃银品质更优"的句子，同段或紧邻段必须给出订单粮食毛利率 2025H1 约 −0.09%（全年 −1.31%）、2025 年归母净利 −2.12 亿元、2024 年报保留意见与 300 万元罚款（2026-06-26）/ ST 变更（2026-06-30）、中国种子集团要约收购（首次公告 2025-11-20，要约期 2025-12-04 至 2026-01-05，40.51% 持股于要约期结束后即约 2026-01 达成）。不得分置于不同章节。 |

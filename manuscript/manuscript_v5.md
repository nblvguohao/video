# Mining administrative approval records for technology assessment: record-level trial-channel indicators and third-party-assayed grain quality in China's rice variety registrations, 2017–2022

*Running title:* Mining approval records for trial-channel indicators of rice quality
...
1. Administrative approval text is mined into a record-level innovation indicator set.
...
5. Evidence strength varies across fields of one source with who measured the field.
...
The documents in which that split can be observed belong to a class of evidence that science-and-technology (S&T) intelligence work has barely touched. Innovation measurement still rests overwhelmingly on a few curated indicator families — publications, patents and, more recently, trademarks and firm web traces — and the methodological literature is concentrated in the same place: text mining in innovation research has been developed and surveyed almost entirely over patent and publication corpora (Losiewicz et al., 2000; Antons et al., 2020), and even the recent turn to "big data" firm-level indicators draws mainly on web, job-posting and transaction traces rather than on the regulatory record (Rammer and Es-Sadki, 2023). Administrative approval and registration records — the documents a state produces when it decides that a technology may be placed on the market — sit outside this frame, not because they are secret but because they are unstructured: they are published as running prose, one announcement at a time, and must be parsed before they can be counted. Crop variety approval announcements are among the most information-dense members of this class. A single record carries the applicant, the trial the variety was tested in, the named check it was compared against, and more than a dozen measured agronomic, grain-quality and resistance fields, each with an identifiable measuring party. The first contribution of this paper is accordingly a methodological one for S&T intelligence: we convert this long-public corpus into a structured, record-level indicator system, and then show what technology assessment that system supports.

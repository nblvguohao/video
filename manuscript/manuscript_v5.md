...
10. **This paper does not evaluate the overall financial performance, business strategy, or corporate governance of any applicant firm, including Winall.** The channel-choice and within-channel quality comparisons in §7 are silent on firm-level profitability.
...
- **R10 (drop the focal firm).** Dropping all Winall-linked records leaves the headline result significant with the same sign: head-rice −1.368 pp (p = 0.006, n = 602), chalkiness +0.940 pp (p = 0.034, n = 599), stated grade −0.104 (p = 0.011, n = 609) (Table 4). Conclusion: the result does not depend on this single firm; see also §7.
...
*The varieties carrying this germplasm lineage enter the paper as a counter-case that rules out an alternative explanation, not as a source of the main result.*

The sign separation reported in Sections 5–6 is consistent with measurement discretion in self-organised trials, but it is equally consistent with a cruder alternative: perhaps seed-marketing enterprises are simply less careful breeders than public research institutes, and the new channels happen to be where enterprises concentrate. If so, the quality gap would reflect *who* enters through each door, not *how* the door is measured. The germplasm lineage associated with Anhui Winall Hi-Tech Seed Co. lets us put that alternative to a direct test. The lineage originates with a certified breeding-production-extension enterprise holding Ministry of Agriculture and Rural Affairs "strong-advantage" seed-company status — the applicant profile the green channel was designed to serve — and varieties carrying it account for a rising share of national approvals in the two major indica trial groups, from 0–12% in 2005–2015 to 23–31% in 2022–2024 (the latter figures rest on the partial post-2022 coverage described in §3.4). Contract design for order-grain quality incentives at this firm is separately modelled by Xie et al. (2023) with a three-tier supply-chain game and a numerical example, at the firm level and without variety-level data; nothing below draws on it. If enterprise-bred germplasm is simply the less carefully bred germplasm, varieties carrying this lineage should be the entries that look *most* like the new channel.

They are not. Restricting to national approvals in 2017 and 2019–2022, records carrying this lineage (n = 166; identified by the pedigree-and-naming entity-resolution rule described in §3.1, whose 0.770 recall biases every comparison below toward zero) entered through the unified channel 60.2% of the time, against 47.5% for all other records (n = 1,101) (Table 5; Fig. 6a). A logit for the channel of entry, conditioning on year×trial-group fixed effects, shows this is not an artefact of when or in which trial group these varieties were submitted: carrying the lineage is associated with roughly half the odds of entering through a new channel (α = −0.728, SE = 0.182, p < 0.0001, odds ratio 0.483; robust in magnitude and sign, though somewhat attenuated, under a no-fixed-effects specification and a two-major-trial-group-only sample). The channel is chosen by whichever organisation files, not by the germplasm; the estimate describes where varieties of this lineage are observed to enter. Within the unified channel these varieties record higher head-rice percentage (+2.212 points), a higher probability of a stated quality grade (+9.8 points) and lower chalkiness (−0.692 points) than other unified entrants (all p < 0.001), while inside the new-channel subsample the same three comparisons lose significance (p > 0.18 throughout) and the point estimates move toward zero or reverse sign (Table 5; Fig. 6b). The measured gap therefore appears against entrants tested in the same state-run trial and not against entrants tested in self-organised trials. What differs between the two comparisons is the set of varieties compared against, not the measuring party: head-rice, chalkiness and the stated grade are assayed by the same designated third-party laboratories under NY/T 593 in either channel (§2; §3.3). Three nulls on a smaller subsample are consistent with, but do not by themselves establish, the absence of a general breeding advantage in this germplasm.

Dropping every record carrying this lineage from the main consortium-versus-unified comparison leaves the headline result intact (Section 6.1, R10; Table 4): head-rice percentage −1.368 pp (p = 0.006, n = 602), chalkiness degree +0.940 pp (p = 0.034, n = 599), and stated quality grade −0.104 (p = 0.011, n = 609). The main result does not depend on these records.
